...
export default function PeplGraph() {
  ...
  useEffect(() => {
    ...
    const resolveFont = () => {
      ...
      /* the name-label tints and the guidelines' rainbow edge ride the same
         path: Teri's full spectrum scale, read straight off :root (the
         --film-* aliases above are eight steps of this same set). A missing
         token drops out of the palette rather than being replaced — no hex is
         ever invented here. */
      ...
      sheet.bakePalette(); // no-op until the layout exists; resize bakes it too
    };
    resolveFont();
