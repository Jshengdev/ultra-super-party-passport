  ...
  return (
    <main className={styles.shell}>
      ...
      {(status === 'live' || status === 'demo') && (
        ...
        >
          {/* the box stays plain and readable (raw/0034) — the wave lives ON the graph */}
          <input
            value={query}
